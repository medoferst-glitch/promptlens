    ...
    <main className="flex-1">
      ...
      >
        ...
        <div className="relative max-w-5xl mx-auto">
          ...
          <div
            className="mt-16 mx-auto max-w-3xl rounded-[12px] border border-[#e5e3df] dark:border-[#2e2e2e] bg-white dark:bg-[#1e1e1e] overflow-hidden text-left"
            style={{ boxShadow: "rgba(15, 15, 15, 0.20) 0px 24px 48px -8px" }}
          >
            <div className="flex items-center gap-2 px-4 py-3 border-b border-[#e5e3df] dark:border-[#2e2e2e] bg-[#f6f5f4] dark:bg-[#171717]">
              <span className="w-3 h-3 rounded-full bg-[#e5e3df] dark:bg-[#2e2e2e]" />
              <span className="w-3 h-3 rounded-full bg-[#e5e3df] dark:bg-[#2e2e2e]" />
              <span className="w-3 h-3 rounded-full bg-[#e5e3df] dark:bg-[#2e2e2e]" />
              <span className="ml-3 text-xs text-[#a4a097] dark:text-[#686868] font-medium">PromptLens Studio</span>
            </div>
            <div className="p-6 flex flex-col sm:flex-row gap-6">
              <div className="flex-1 rounded-[8px] bg-[#f6f5f4] dark:bg-[#171717] border border-[#e5e3df] dark:border-[#2e2e2e] aspect-square sm:aspect-auto sm:h-40 flex items-center justify-center">
                <svg className="w-10 h-10 text-[#c8c4be] dark:text-[#3e3e3e]" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1}>
              ...
              <div className="flex-[2] flex flex-col gap-3">
                <div className="text-xs font-semibold text-[#787671] dark:text-[#909090] uppercase tracking-[1px]">Generated Prompt</div>
                <div className="space-y-2">
                  <div className="h-3 rounded-full bg-[#e5e3df] dark:bg-[#2e2e2e] w-full" />
                  <div className="h-3 rounded-full bg-[#e5e3df] dark:bg-[#2e2e2e] w-5/6" />
                  <div className="h-3 rounded-full bg-[#e5e3df] dark:bg-[#2e2e2e] w-4/6" />
                  <div className="h-3 rounded-full bg-[#e5e3df] dark:bg-[#2e2e2e] w-3/4" />
                </div>
      ...
      <section className="py-24 px-4 sm:px-6 lg:px-8 bg-white dark:bg-[#111111] border-t border-[#e5e3df] dark:border-[#2e2e2e] transition-colors">
        <div className="max-w-6xl mx-auto">
          <h2 className="text-center text-3xl sm:text-4xl font-semibold text-[#1a1a1a] dark:text-[#f0f0f0] mb-3 tracking-[-0.5px]">
            Everything you need to recreate any image
          </h2>
          <p className="text-center text-[#787671] dark:text-[#909090] mb-14 text-base">No prompt engineering expertise required.</p>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
            {[
              ...
              <div key={f.title} className={`${f.tint} rounded-[12px] p-8`}>
                <div className="w-10 h-10 bg-white/70 dark:bg-white/10 rounded-[8px] flex items-center justify-center text-[#37352f] dark:text-[#d4d4d4] mb-5">
                  {f.icon}
                </div>
                <h3 className="text-[#37352f] dark:text-[#d4d4d4] font-semibold text-lg mb-2">{f.title}</h3>
                <p className="text-[#5d5b54] dark:text-[#a0a0a0] text-sm leading-relaxed">{f.desc}</p>
              </div>
            ))}
          </div>
        </div>
      ...
      {/* How it works */}
      <section className="py-24 px-4 sm:px-6 lg:px-8 bg-[#f6f5f4] dark:bg-[#171717] transition-colors">
        <div className="max-w-4xl mx-auto text-center">
          <h2 className="text-3xl sm:text-4xl font-semibold text-[#1a1a1a] dark:text-[#f0f0f0] mb-3 tracking-[-0.5px]">How It Works</h2>
          <p className="text-[#787671] dark:text-[#909090] mb-16 text-base">Three steps. That&apos;s it.</p>
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-10">
            {[
              ...
              <div key={s.step} className="flex flex-col items-center">
                <div className="text-6xl font-bold text-[#e5e3df] dark:text-[#2e2e2e] mb-3 font-mono">{s.step}</div>
                <h3 className="text-[#1a1a1a] dark:text-[#f0f0f0] font-semibold text-base mb-2">{s.title}</h3>
                <p className="text-[#787671] dark:text-[#909090] text-sm leading-relaxed">{s.desc}</p>
              </div>
            ))}
          </div>
          <Link
      ...
      {/* CTA banner */}
      <section className="py-24 px-4 sm:px-6 lg:px-8 bg-white dark:bg-[#111111] transition-colors">
        <div className="max-w-4xl mx-auto">
          <div className="bg-[#f6f5f4] dark:bg-[#1e1e1e] rounded-[12px] px-8 py-16 text-center">
            <h2 className="text-3xl sm:text-4xl font-semibold text-[#1a1a1a] dark:text-[#f0f0f0] mb-4 tracking-[-0.5px]">
              Ready to get started?
            </h2>
            <p className="text-[#787671] dark:text-[#909090] mb-8 text-base max-w-sm mx-auto">
